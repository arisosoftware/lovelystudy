...
public class TableDescriptor {
	...
	public TableDescriptor(String name, String entityName, String basePackageName, String baseUri,
			String serPackageName, String repoPackageName, String modPackageName) {
		this.name = name;
	...
	public List<ColumnDescriptor> getIndexColumns() {
		...
		for (ColumnDescriptor column : columns) {
			if (!Strings.isBlank(column.getLabel()) && !"id".equalsIgnoreCase(column.columnName)) {
				result.add(column);
			}
		}
